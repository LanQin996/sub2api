export default {
  ...
  dashboard: {
    ...
    modelMarketplace: '模型广场',
    browseModelsAndPricing: '浏览可用模型与价格',
    redeemCode: '兑换码',
  ...
  ranking: {
    title: '排行榜',
    description: '查看当前周期的用户、Token 与模型排行',
    daily: '日榜',
    weekly: '周榜',
    monthly: '月榜',
    yearly: '年榜',
    allTime: '全部时间',
    currentRanking: '当前榜单',
    userRankingTab: '用户消费榜',
    tokenRankingTab: 'Token 消耗榜',
    modelRankingTab: '模型榜',
    userRanking: '用户消费榜',
    userRankingDesc: '按消费排序，但隐藏具体消费金额',
    tokenRanking: 'Token 消耗排行榜',
    tokenRankingDesc: '按 Token 消耗排序，隐藏具体消费金额',
    modelRanking: '热门模型',
    myRanking: '我的排名',
    vendorShare: '市场份额',
    vendorShareDesc: '按 Token 用量聚合的供应商占比',
    topMovers: '上升趋势',
    topMoversDesc: '排名上升的模型',
    topDroppers: '下降趋势',
    topDroppersDesc: '排名下滑的模型',
    totalSpend: '榜单消费',
    totalRequests: '总请求数',
    totalTokens: '总 Token',
    totalModels: '模型数',
  ...
  admin: {
    ...
    channels: {
      ...
      form: {
        ...
        noModels: '未添加模型',
        excludedGroups: '排除分组',
        excludedGroupsHint: '勾选后，这些分组不能使用本条模型',
        excludedGroupsCount: '排除 {count} 组',
        ...
        officialPricingOverwriteTitle: '从默认定价库获取并覆盖当前价格和官方区间',
        officialLongContextTier: '官方长上下文',
    ...
    accounts: {
      ...
      dataImportFile: '数据文件',
      dataImportFileHint: 'JSON (.json)，可多选',
      dataImportSelectedFiles: '已选择 {count} 个文件',
      dataImportInvalidFile: '{file} 不是有效的数据文件',
    ...
    redeem: {
      ...
      value: '面值',
      count: '数量',
      maxRedemptions: '可兑换份数',
      perUserLimit: '限制每人仅兑换一次',
      randomAmount: '拼手气余额',
      randomMinAmount: '最小金额 ($)',
      randomMaxAmount: '最大金额 ($)',
      randomAmountInvalid: '请输入有效的随机金额范围',
      generate: '生成',
      copyAll: '全部复制',
      download: '下载',
    ...
    settings: {
      ...
      features: {
        ...
        availableChannels: {
          title: '模型广场',
          description: '向已登录用户展示按模型聚合的可用渠道、分组倍率和价格提示。默认关闭。',
          configureLink: '前往 渠道管理 > 渠道定价 配置模型价格',
          enabled: '启用模型广场',
          enabledHint: '关闭后用户端侧边栏和控制台入口隐藏，接口返回空数组。',
        },
        riskControl: {
          title: '风控中心',
      ...
      defaults: {
        ...
        autoConcurrencyUpgrade: '按消费自动提升并发',
        autoConcurrencyUpgradeHint: '根据用户累计实际消费自动提高并发。已手动调到高于上限的用户不会被降低。',
        autoConcurrencySpendThreshold: '每消费满多少',
        autoConcurrencyStep: '每次提高并发',
        autoConcurrencyMax: '最高自动并发',
        autoConcurrencyInvalid: '自动提升并发需要填写大于 0 的消费门槛、提升并发数和最高自动并发。',
        autoConcurrencyMaxTooLow: '最高自动并发不能低于默认并发数。',
