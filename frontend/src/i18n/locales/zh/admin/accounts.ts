export default {
    ...
    accounts: {
      ...
      dataImportWarning: '导入将创建新账号与代理，所选群组会按平台匹配导入账号；每个账号都需至少有一个兼容群组，开启混合调度的 Antigravity 账号也可匹配 Anthropic/Gemini 群组。未选择任何群组时账号保持未分组。',
      dataImportFile: '数据文件',
      ...
      dataImportGroupPlatformMismatch: '以下账号平台没有对应的已选群组：{platforms}',
      dataImportMixedChannelWarningTitle: '确认混合渠道导入',
      dataImportMixedChannelWarning: '已选群组中存在与导入账号不同渠道的账号。混合渠道可能导致思考块签名校验失败，并回退到非思考模式。确认仍要继续导入吗？',
      dataImportMixedChannelConfirm: '确认并继续',
