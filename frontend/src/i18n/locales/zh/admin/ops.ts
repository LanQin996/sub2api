export default {
    ops: {
      ...
      runtime: {
        ...
        metricThresholdsHint: '配置运维健康状态与告警评估所使用的阈值。',
        slaMinPercent: '最低 SLA（%）',
        slaMinPercentHint: 'SLA 低于该百分比时，健康状态将下降。',
        ttftP99MaxMs: '最大 TTFT P99（毫秒）',
        ttftP99MaxMsHint: '首 Token 时间 P99 超过该值时，健康状态将下降。',
        requestErrorRateMaxPercent: '最大请求错误率（%）',
        requestErrorRateMaxPercentHint: '整体请求错误率超过该百分比时，健康状态将下降。',
        upstreamErrorRateMaxPercent: '最大上游错误率（%）',
        upstreamErrorRateMaxPercentHint: '上游错误率超过该百分比时，健康状态将下降。',
        silencing: {
          title: '告警静默（维护模式）',
          enabled: '启用静默',
