export default {
    ops: {
      ...
      runtime: {
        ...
        metricThresholdsHint: 'Configure the thresholds used to evaluate overall Ops health and alerts.',
        slaMinPercent: 'Minimum SLA (%)',
        slaMinPercentHint: 'Health degrades when SLA falls below this percentage.',
        ttftP99MaxMs: 'Maximum TTFT P99 (ms)',
        ttftP99MaxMsHint: 'Health degrades when P99 time to first token exceeds this value.',
        requestErrorRateMaxPercent: 'Maximum Request Error Rate (%)',
        requestErrorRateMaxPercentHint: 'Health degrades when the overall request error rate exceeds this percentage.',
        upstreamErrorRateMaxPercent: 'Maximum Upstream Error Rate (%)',
        upstreamErrorRateMaxPercentHint: 'Health degrades when the upstream error rate exceeds this percentage.',
        silencing: {
