export default {
    ...
    accounts: {
      ...
      dataImportWarning: 'Import creates new accounts and proxies. Every account needs at least one compatible selected group; Antigravity accounts with mixed scheduling can also use Anthropic/Gemini groups. With no groups selected, accounts remain ungrouped.',
      ...
      dataImportGroupPlatformMismatch: 'No selected group matches these account platforms: {platforms}',
      dataImportMixedChannelWarningTitle: 'Confirm Mixed-Channel Import',
      dataImportMixedChannelWarning: 'A selected group already contains accounts from a different channel. Mixing channels may cause thinking-block signature validation to fail and fall back to non-thinking mode. Continue with the import?',
      dataImportMixedChannelConfirm: 'Confirm and Continue',
