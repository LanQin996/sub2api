export default {
  ...
  dashboard: {
    ...
    modelMarketplace: 'Model Marketplace',
    browseModelsAndPricing: 'Browse models and pricing',
  ...
  ranking: {
    title: 'Ranking',
    description: 'View user, token and model rankings for the current period',
    daily: 'Daily',
    weekly: 'Weekly',
    monthly: 'Monthly',
    yearly: 'Yearly',
    ...
    userRankingTab: 'User Spend',
    tokenRankingTab: 'Token Usage',
    modelRankingTab: 'Models',
    userRanking: 'User Spending Ranking',
    userRankingDesc: 'Ranked by spend, without exposing exact spend',
    tokenRanking: 'Token Usage Ranking',
    tokenRankingDesc: 'Ranked by token usage, without exposing exact spend',
    modelRanking: 'Popular Models',
    myRanking: 'My Ranking',
    vendorShare: 'Market Share',
    vendorShareDesc: 'Provider share aggregated by token usage',
    topMovers: 'Top Movers',
    topMoversDesc: 'Models climbing in rank',
    topDroppers: 'Top Droppers',
    topDroppersDesc: 'Models falling in rank',
  ...
  admin: {
    ...
    channels: {
      ...
      form: {
        ...
        excludedGroupsHint: 'Checked groups cannot use the models in this entry',
        excludedGroupsCount: '{count} excluded',
        ...
        officialPricingOverwriteTitle: 'Fetch from default pricing data and overwrite current prices and official intervals',
        officialLongContextTier: 'Official long context',
    ...
    accounts: {
      ...
      dataImportInvalidFile: '{file} is not a valid data file',
    ...
    redeem: {
      ...
      value: 'Value',
      count: 'Count',
      maxRedemptions: 'Redeemable Shares',
      perUserLimit: 'Limit each user to one redemption',
      randomAmount: 'Random balance amount',
      randomMinAmount: 'Minimum Amount ($)',
      randomMaxAmount: 'Maximum Amount ($)',
      randomAmountInvalid: 'Please enter a valid random amount range',
      generating: 'Generating...',
      generate: 'Generate',
      copyAll: 'Copy All',
      copied: 'Copied!',
    ...
    usage: {
      ...
      cacheCreationShort: 'Cache write',
    ...
    settings: {
      ...
      features: {
        ...
        availableChannels: {
          title: 'Model Marketplace',
          description: 'Show logged-in users a model-first view of available channels, group multipliers, and pricing hints. Disabled by default.',
          configureLink: 'Configure model pricing in Channel Management > Channel Pricing',
          enabled: 'Enable Model Marketplace',
          enabledHint: 'When off, the user sidebar and dashboard entries are hidden and the endpoint returns an empty list.',
        },
        riskControl: {
          title: 'Risk Control',
      ...
      defaults: {
        ...
        autoConcurrencyUpgrade: 'Auto Concurrency Upgrade',
        autoConcurrencyUpgradeHint: 'Increase user concurrency automatically based on cumulative actual spend. Users already above the cap are not reduced.',
        autoConcurrencySpendThreshold: 'Spend Threshold',
        autoConcurrencyStep: 'Concurrency Increase',
        autoConcurrencyMax: 'Maximum Auto Concurrency',
        autoConcurrencyInvalid: 'Auto concurrency upgrade requires a positive spend threshold, increase, and maximum.',
        autoConcurrencyMaxTooLow: 'Maximum auto concurrency must be greater than or equal to default concurrency.',
