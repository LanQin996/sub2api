export default {
  ...
  usage: {
    ...
    sync: 'Sync',
    unknown: 'Unknown',
    partialUsage: 'Interrupted billing',
    partialUsageHint: 'The stream ended before terminal usage was available, so billing used a conservative partial-output estimate.',
    in: 'In',
    out: 'Out',
