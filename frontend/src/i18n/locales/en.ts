      ...
      features: {
        ...
        affiliate: {
          ...
          customUsers: {
            ...
            batchEnableButton: 'Batch Allow ({count} selected)',
            batchDisableButton: 'Batch Deny ({count} selected)',
          ...
          modal: {
            ...
            enabledLabel: 'Allow invite rebate',
            enabledHint: 'When off, this user cannot access the affiliate page and their code cannot bind new invitees.',
