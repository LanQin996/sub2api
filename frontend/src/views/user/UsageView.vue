              ...
              <div class="space-y-1.5 text-sm">
                ...
                <div class="flex items-start gap-4">
                  ...
                  <div class="min-w-[5.5rem] space-y-0.5">
                    ...
                    <div v-if="(row.cache_read_tokens ?? 0) > 0" class="pl-5 text-[11px] leading-tight text-sky-600 dark:text-sky-400">
                      <span class="text-gray-500 dark:text-gray-400">{{ t('admin.usage.cacheReadShort') }}</span>
                      <span class="ml-1 font-medium">{{ (row.cache_read_tokens ?? 0).toLocaleString() }}</span>
                    </div>
                  </div>
                  <!-- Output -->
                ...
                <!-- Cache Write -->
                <div
                  v-if="(row.cache_creation_tokens ?? 0) > 0"
                ...
                >
                  ...
                  <span v-if="(row.cache_creation_1h_tokens ?? 0) > 0" class="inline-flex items-center rounded px-1 py-px text-[10px] font-medium leading-tight bg-orange-100 text-orange-600 ring-1 ring-inset ring-orange-200 dark:bg-orange-500/20 dark:text-orange-400 dark:ring-orange-500/30">1h</span>
                ...
                <div v-if="hasImageOutputTokens(row)" class="flex items-center gap-2">
                  <div class="inline-flex items-center gap-1">
                    ...
                    <span class="font-medium text-pink-600 dark:text-pink-400">{{ (row.image_output_tokens ?? 0).toLocaleString() }}</span>
                  </div>
                </div>
              </div>
