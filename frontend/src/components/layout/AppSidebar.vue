...
const flagUserAffiliate = () => flagAffiliate() && authStore.user?.affiliate_enabled === true
...
//
// 条目顺序：密钥 → 用量/排行 → 可用渠道 → 渠道状态 → 订阅/支付 → 兑换/资料。
...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/affiliate', label: t('nav.affiliate'), icon: UsersIcon, hideInSimpleMode: true, featureFlag: flagUserAffiliate },
