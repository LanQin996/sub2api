...
func init() {
	...
	accountDescContributionStatus := accountFields[29].Descriptor()
	...
	contributorrewardlogFields := schema.ContributorRewardLog{}.Fields()
	_ = contributorrewardlogFields
	// contributorrewardlogDescRequestID is the schema descriptor for request_id field.
	contributorrewardlogDescRequestID := contributorrewardlogFields[0].Descriptor()
	// contributorrewardlog.RequestIDValidator is a validator for the "request_id" field. It is called by the builders before save.
	contributorrewardlog.RequestIDValidator = func() func(string) error {
		validators := contributorrewardlogDescRequestID.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// contributorrewardlogDescTotalCost is the schema descriptor for total_cost field.
	contributorrewardlogDescTotalCost := contributorrewardlogFields[6].Descriptor()
	// contributorrewardlog.DefaultTotalCost holds the default value on creation for the total_cost field.
	contributorrewardlog.DefaultTotalCost = contributorrewardlogDescTotalCost.Default.(float64)
	// contributorrewardlogDescActualCost is the schema descriptor for actual_cost field.
	contributorrewardlogDescActualCost := contributorrewardlogFields[7].Descriptor()
	// contributorrewardlog.DefaultActualCost holds the default value on creation for the actual_cost field.
	contributorrewardlog.DefaultActualCost = contributorrewardlogDescActualCost.Default.(float64)
	// contributorrewardlogDescRewardMultiplier is the schema descriptor for reward_multiplier field.
	contributorrewardlogDescRewardMultiplier := contributorrewardlogFields[8].Descriptor()
	// contributorrewardlog.DefaultRewardMultiplier holds the default value on creation for the reward_multiplier field.
	contributorrewardlog.DefaultRewardMultiplier = contributorrewardlogDescRewardMultiplier.Default.(float64)
	// contributorrewardlogDescRewardAmount is the schema descriptor for reward_amount field.
	contributorrewardlogDescRewardAmount := contributorrewardlogFields[9].Descriptor()
	// contributorrewardlog.DefaultRewardAmount holds the default value on creation for the reward_amount field.
	contributorrewardlog.DefaultRewardAmount = contributorrewardlogDescRewardAmount.Default.(float64)
	// contributorrewardlogDescCreatedAt is the schema descriptor for created_at field.
	contributorrewardlogDescCreatedAt := contributorrewardlogFields[10].Descriptor()
	// contributorrewardlog.DefaultCreatedAt holds the default value on creation for the created_at field.
	contributorrewardlog.DefaultCreatedAt = contributorrewardlogDescCreatedAt.Default.(func() time.Time)
	...
	// userDescInvitationEnabled is the schema descriptor for invitation_enabled field.
	userDescInvitationEnabled := userFields[21].Descriptor()
	// user.DefaultInvitationEnabled holds the default value on creation for the invitation_enabled field.
	user.DefaultInvitationEnabled = userDescInvitationEnabled.Default.(bool)
