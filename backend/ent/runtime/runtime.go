...
func init() {
	...
	// usagelogDescPartialUsage is the schema descriptor for partial_usage field.
	usagelogDescPartialUsage := usagelogFields[29].Descriptor()
	// usagelog.DefaultPartialUsage holds the default value on creation for the partial_usage field.
	usagelog.DefaultPartialUsage = usagelogDescPartialUsage.Default.(bool)
