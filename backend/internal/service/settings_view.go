...
type SystemSettings struct {
	...
	InvitationHighSpenderEnabled     bool
	...
	AutoConcurrencyUpgradeEnabled        bool
	AutoConcurrencyUpgradeSpendThreshold float64
	AutoConcurrencyUpgradeStep           int
	AutoConcurrencyUpgradeMax            int
