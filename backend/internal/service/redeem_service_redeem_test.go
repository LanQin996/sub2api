...
func (r *redeemRejectRepo) RedeemOnce(ctx context.Context, code *RedeemCode, userID int64, value float64) error {
	panic("unexpected RedeemOnce call")
}

func (r *redeemRejectRepo) CreateUsage(ctx context.Context, codeID, userID int64, value float64, createdAt time.Time) error {
...
func (r *redeemRejectRepo) ListUsagesByCode(ctx context.Context, codeID int64, params pagination.PaginationParams) ([]RedeemCodeUsage, *pagination.PaginationResult, error) {
