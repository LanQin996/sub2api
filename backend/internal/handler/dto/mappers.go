...
func redeemCodeFromServiceBase(rc *service.RedeemCode) RedeemCode {
	out := RedeemCode{
		...
		Value:               rc.Value,
		Status:              rc.Status,
		MaxRedemptions:      rc.MaxRedemptions,
		RedeemedCount:       rc.RedeemedCount,
		PerUserLimit:        rc.PerUserLimit,
		RandomAmountEnabled: rc.RandomAmountEnabled,
		RandomMinValue:      rc.RandomMinValue,
		RandomMaxValue:      rc.RandomMaxValue,
		UsedBy:              rc.UsedBy,
